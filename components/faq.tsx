...
const items: Item[] = [
  {
    q: "நாங்கள் ஏன் Modern Tech Stack தேர்ந்தெடுக்கிறோம்?",
  ...
  {
    q: "எவ்வளவு நேரத்தில் இணையதளம் live ஆகும்?",
