    ...
    <section className="pt-24 pb-16 px-6 min-h-[92vh] flex items-center">
      <div className="w-full max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
        ...
        >
          ...
          >
            இணையதளம் அமைப்பதற்கான தொழில்நுட்பக் கருவிகள் மற்றும் டிஜிட்டல் தொழில்நுட்பம் குறித்த புரிதல் இல்லாததுடன், அதற்காகச் செலவிட போதிய நேரமும் பெரும்பாலான வணிகர்களுக்கு ஒரு தடையாக உள்ளது.
          </motion.p>
